...
func Notification(variant string, msg string, description string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div id=\"app-notifications\" x-merge=\"append\" class=\"flex w-full flex-col items-center space-y-4 sm:items-end\"><div x-data=\"{\n                show: false,\n                progress: 100,\n                init() {\n                    this.$nextTick(() =&gt; this.show = true )\n                    setTimeout(() =&gt; this.progress = 0, 100)\n \n                    setTimeout(() =&gt; this.transitionOut(), 3000)\n                },\n                transitionOut() {\n                    this.show = false\n \n                    setTimeout(() =&gt; $el.remove(), 500)\n                },\n            }\" x-show=\"show\" x-transition.duration.500ms class=\"pointer-events-auto w-full max-w-sm overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-black/5\"><div class=\"p-4\"><div class=\"flex items-start\"><div class=\"shrink-0\"><svg class=\"size-6 text-green-400\" fill=\"none\" viewBox=\"0 0 24 24\" stroke-width=\"1.5\" stroke=\"currentColor\" aria-hidden=\"true\" data-slot=\"icon\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z\"></path></svg></div><div class=\"ml-3 w-0 flex-1 pt-0.5\"><p class=\"text-sm font-medium text-gray-900\">Successfully saved!</p><p class=\"mt-1 text-sm text-gray-500\">Anyone with a link can now view this file.</p><div class=\"mt-4 overflow-hidden rounded-full bg-neutral-200\"><div class=\"h-2 rounded-full bg-neutral-500 transition-all ease-linear duration-2900\" x-bind:style=\"&#39;width: &#39; + progress + &#39;%;&#39;\"></div></div></div><div class=\"ml-4 flex shrink-0\"><button @click=\"show=false\" type=\"button\" class=\"inline-flex rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2\"><span class=\"sr-only\">Close</span> <svg class=\"size-5\" viewBox=\"0 0 20 20\" fill=\"currentColor\" aria-hidden=\"true\" data-slot=\"icon\"><path d=\"M6.28 5.22a.75.75 0 0 0-1.06 1.06L8.94 10l-3.72 3.72a.75.75 0 1 0 1.06 1.06L10 11.06l3.72 3.72a.75.75 0 1 0 1.06-1.06L11.06 10l3.72-3.72a.75.75 0 0 0-1.06-1.06L10 8.94 6.28 5.22Z\"></path></svg></button></div></div></div></div></div>")
		if templ_7745c5c3_Err != nil {
